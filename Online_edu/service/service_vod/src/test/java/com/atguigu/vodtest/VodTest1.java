...
public class VodTest1 {
    ...
    public static void main(String[] argv) throws ClientException {
        ...
        String fileName = "G:/6 - What If I Want to Move Faster.mp4";  //本地文件路径和名称
        //上传视频的方法
    ...
    public static void getPlayAuth() throws Exception{
        DefaultAcsClient client = initVodClient("LTAI5tG9kuNgvhgmwUM1Ac2n","6bytO9P0IpgMJCe39czSUEs0OUtkYD");
