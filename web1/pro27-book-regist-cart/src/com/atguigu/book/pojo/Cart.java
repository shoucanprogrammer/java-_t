...
public class Cart {
    ...
    private Integer totalCount;                  //购物车中书的数量
    ...
    public Double getTotalMoney() {
        ...
        if (cartItemMap != null && cartItemMap.size()>0){
            ...
            for (Map.Entry<Integer,CartItem> cartItemEntry:entries){
                ...
                BigDecimal bigDecimalXJ= new BigDecimal(""+cartItem.getBook().getPrice()).multiply(new BigDecimal(""+cartItem.getBuyCount()));
                bigDecimaltotalMoney = bigDecimaltotalMoney.add(bigDecimalXJ) ; ;
            }
        }
